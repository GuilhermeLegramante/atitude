<div id="resultModal"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-3xl p-6 relative">
        <button onclick="closeResultModal()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600">
            <x-heroicon-o-x-mark class="w-6 h-6" />
        </button>

        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <x-heroicon-o-check-circle class="w-6 h-6 text-sky-600" />
            Minhas Respostas
        </h2>

        <div id="resultContent" class="space-y-4 text-gray-800 dark:text-gray-200">
            <p class="text-center text-gray-500 dark:text-gray-400">Carregando respostas...</p>
        </div>
    </div>
</div>
