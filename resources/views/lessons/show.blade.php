@php
    ...
    // Espera um $lesson (title, subtitle, description, video_url, duration, resources [name,url], teacher[name,avatar], progressPercent)
@endphp
...
<head>
    ...
    <title>{{ $lesson->title ?? 'Aula' }} — Plataforma</title>
            ...
            <div class="hidden lg:block">
                <div class="sticky top-6 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow border p-4 w-80">
                        ...
                        <a href="#"
                            class="mt-3 inline-block px-3 py-2 rounded-lg bg-sky-600 text-white text-sm">Ver
                            certificado</a>
                    </div>
                </div>
            </div>
